...
Estimates range from 0.01 to 10 mergers per Mpc${}^{3}$ per Myr.
...
the discovery rate of CBC mergers will be of approximately 40/yr.
...
correcting for Doppler shift for the motion of the Earth around the Sun, and spin-down of the pulsar, among other effects.
...
Random Forest can also provide an importance score for each feature, based on how fat up in the tree structure it is within a tree.
