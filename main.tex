...
Kilonovae are 1,000 times brighter than a nova. Observational and theoretical evidence suggest a relation between... 
...
Most importantly, the merger of a binary system involving a NS is very complex and several kind of factors can effect the radiation pattern and light-curve of the Kilonova as well as the GRW waveform. The optical light curve can serve as a probe into the core and shed light to the intricacies and details of the merge process.
...
On April 2014, TOROS signed a Memorandum Of Understanding (MOU) with the LIGO Virgo Collaboration, in order to participate in a program to perform follow-up observations of GW candidate events with the sharing of proprietary information.
...
The MOU allowed TOROS to receive the LIGO alerts, which are private and confidential at the time of O1 and to be part of a publication as part of a broader collaboration with other institutions for the electromagnetic counterpart search of the first announced GW ever, namely GW160914.

To this end, TOROS applied for a Memorandum Of Understanding (MOU) with LVC, along with other XX observing sites, which was approved and signed. This allowed TOROS to receive the alerts for the O1 LIGO campaign and the following ones.
