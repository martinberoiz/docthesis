...
Random Forest can also provide an importance score based on how up in the tree structure it is position within a tree.
...
In figure \ref{ig:rbfeathist} we can see the histograms for the real population and the bogus populations separated, for the 4 most 
important features given by the Random Forest fit.
We can see that none of the features by itself clearly separates the data, as it is usual the case for typical features.
