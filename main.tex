...
\item For each triangle in that set, calculate the tuple of invariants in \ref{}, that uniquely identify the triangle and push the invariant tuple into another kd-tree.
