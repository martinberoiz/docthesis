...
There are different types of skymaps provided by LVC.
They come from different parts of the LVC pipeline and they are done with different levels of information.

Even though the last ones are the most precise, by the time they are released most of the observations are already done.
...
The skymaps provided with the alert typically cover an order of \textasciitilde100 square degrees for the 90\% confidence region.
...
the Gravitational Waves Galaxy Catalog (GWGGC).
...
and we will not cover this on this section.
Instead, for the purpose of testing the Optimal Subtraction and Real-Bogus Classifier steps, we discuss here the use of a test image set.

The Chinese Small Telescope ARray (CSTAR) is the first Chinese astronomical instrument 
on the Antarctic ice cap (\citet{2010RAA....10..279Z}).
