...
After 100 years after the prediction of Gravitational Waves (GW from hereon) LIGO made the first direct in situ detection of the first Gravitational Wave labeled GW150914. The history of GW ...
...
These wave solutions are called Gravitational Waves.
...
They discovered that the slow rate of period decrease of the pulses precisely matched General Relativity predictions.

Nonetheless, a direct detection of GW wouldn't come for another 50 years.
In September 14, 2015, a GW detection labelled GW150914 was finally made by the LIGO Collaboration.
...
These tiny resonant oscillations could in principle be measured. Even though ingenious, the carefully devised experiment could not yield positive reproducible results that convinced the scientific community.
...
In the case of the Earth based observatories, each interferometer is one arm of an L shape facility.
The masses are the end mirrors that reflect a laser beam pointed in each arm direction. 
On normal circumstances, the beams from two different arms can be set to be on a dark or bright fringe of the interferometer diffraction pattern.
...
In the following section I offer a more detailed account on the operation of the LIGO observatory.
...
LIGO just pierced the GW window in the 10Hz to 7kHz frequency band.
