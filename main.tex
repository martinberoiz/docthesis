...
Given the huge scale of energies involved, many people favored the idea that GRBs were being produced in the halo of our Milky Way.
...
BeppoSAX reduced the time of localization to a few hours.
...
Twenty hours after the GRB event, a group from the Netherlands lead by, used La Palma telescope in Spain to image the region.
...
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection{The Kilonova, A Case For Multi-Messenger Astronomy} \label{kilonovachapter}
