...
`Kilonova'\footnote{It is also reference in the literature under the names `macronova' and xx.}.
...
Both, the GW and the EM information can bring up a more complete picture of the phenomena at hand. (Bloom J. S., et al., 2009, ApJ, 691, 723)
...
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection{The Kilonova, A New Case For Multi-Messenger Astronomy} \label{kilonovachapter}
...
The intensity of such event can reach brightness of a thousand times those of a Nova, and for this reason it was termed `Kilonova' (Metzger et al., 2010).
...
and fission of the r-process nuclei (Metzger et al. 2010, Barnes et al. 2016, Hotokezaka et al. 2016)
...
In the BH-NS merger there is a chance of Kilonova emission if there is enough NS disruption 
...
(Foucart F., 2012, PRD, 86, 124007 and references therein).
...
In the case of Binary NS systems, if the total mass of the original system exceeds a critical mass between 2.6 and 3.9 solar masses (depending on the used EOS),
...
The final system depends sensitively on the total mass of the original NS-NS binary (e.g., Shibata \& Uryu 2000; Shibata \& Taniguchi 2006). 
Above a threshold mass of Mcrit about 2.6 to 3.9 solar masses the remnant collapses to a BH essentially immediately, 
...
This will result in either a Hyper-Massive NS (HMNS) or a Supra-Massive NS (SMNS).

In the case of a HMSN, the mass is supported exclusively by differential rotation it's called a hypermassive NS (HMNS).
This decays into a BH in a few miliseconds.

For a SMNS, the mass can be supported by solid body rotation and is called a Supra-Massive NS.
...
* Indefinitely stable NS (see magnetar remnant)
