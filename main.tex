...
a VOEvent is an XML file notice that ``{\em defines the content and meaning of a standard information packet for representing, transmitting, publishing and archiving information 
...
Only the images from filter {\em i} in 2010 were usable since the other 3 telescopes failed to return data.
...
\textcolor{red}{Add the convolution in Fourier method from Bruno's paper.}
