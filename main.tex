...
Never before we received signals from distant celestial objects carried away by space-time perturbations.
But these signals, however faint, lack of localization accuracy. 
Their position in the sky can have uncertainties of hundreds of square degrees.

Traditional Astronomy can complement the GW detection weaknesses where optical astronomy is stronger, in localization.
Nonetheless this will also pose technological challenges of a different kind.
In the era of multi-messenger and time-domain Astronomy, low latency response times after detection is a technical challenge without which will be impossible to identify the originator of the signal.
...
This thesis will discuss the implementation of a software pipeline for the TOROS project and the results obtained during the O1 campaign of LIGO.
...
{\em Note: Part the work described in this chapter has been previously published in a 2016 paper with the title 
