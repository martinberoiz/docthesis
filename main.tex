...
LISA (the Laser Interferometer Space Antenna) is a proposed GW interferometer to be set in space trailing the Earth's orbit.
Initially a NASA project, it is now an ESA mission.
The project successfully launched the ``LISA pathfinder'' spacecraft, whose mission is to test technologies needed for the Evolved LISA (eLISA).
