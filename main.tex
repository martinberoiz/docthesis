...
In our pipeline we had many different concerns: the alert system; the image preprocessing; the alignment of images; and the differential photometry of the subtractions.
...
\subsection{Analysis of the invariants}
...
\begin{figure}[htbp]
   \centering
   \includegraphics[width = \linewidth]{figures/astroalign/invariantMap01.pdf}
...
\begin{figure}
   \centering
   \includegraphics[width = \linewidth]{figures/astroalign/idealInvariants.pdf}
